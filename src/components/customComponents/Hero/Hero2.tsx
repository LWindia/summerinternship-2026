...
const Hero2 = () => {
  ...
  return (
    <div className="h-full mx-auto w-full overflow-x-hidden">
      ...
      <div className="relative md:-mt-12 lg:-mt-4 z-30 px-4 md:px-0 -mt-12 md:mt-0">
        <div className="bg-black rounded-lg p-4 md:p-8 shadow-lg max-w-6xl border-2 border-white mx-auto">
